...
- **OLD data** (pre-2013): Scanned PDFs converted to CSV — these raw CSV files are **not** generated by the pipeline and must be obtained separately.
...
by Jason Cruz, Diego Winkelried, and Javier Torres
