...
**Download deduplication:** The downloader keeps a simple record file at `record/downloaded_pdfs.txt` to skip PDFs it has already fetched. Remove entries or delete the file if you want to force re-downloads.
